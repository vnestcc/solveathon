            ...
            {currentIndex > 0 && (
              ...
              >
                <picture>
                  <source 
                    type="image/webp"
                    srcSet={`${events[currentIndex - 1].image}&w=150&fm=webp 150w, ${events[currentIndex - 1].image}&w=300&fm=webp 300w`} 
                  />
                  <img 
                    src={events[currentIndex - 1].image} 
                    srcSet={`${events[currentIndex - 1].image}&w=150 150w, ${events[currentIndex - 1].image}&w=300 300w`}
                    sizes="150px"
            ...
            {currentIndex === 0 && (
              ...
              >
                <picture>
                  <source 
                    type="image/webp"
                    srcSet={`${events[events.length - 1].image}&w=150&fm=webp 150w, ${events[events.length - 1].image}&w=300&fm=webp 300w`} 
                  />
                  <img 
                    src={events[events.length - 1].image} 
                    srcSet={`${events[events.length - 1].image}&w=150 150w, ${events[events.length - 1].image}&w=300 300w`}
                    sizes="150px"
                    alt={events[events.length - 1].title}
                    loading="lazy"
                    decoding="async"
                  />
                </picture>
                ...
                {events.map((event, index) => (
                  ...
                  >
                    <picture>
                      <source 
                        type="image/webp"
                        srcSet={`${event.image}&w=400&fm=webp 400w, ${event.image}&w=600&fm=webp 600w, ${event.image}&w=800&fm=webp 800w`} 
                      />
                      <img 
                        src={event.image} 
                        srcSet={`${event.image}&w=400 400w, ${event.image}&w=600 600w, ${event.image}&w=800 800w`}
            ...
            {events.map((event, index) => (
              ...
              >
                <picture>
                  <source 
                    type="image/webp"
                    srcSet={`${event.image}&w=100&fm=webp 100w, ${event.image}&w=200&fm=webp 200w`} 
                  />
                  <img 
                    src={event.image} 
                    srcSet={`${event.image}&w=100 100w, ${event.image}&w=200 200w`}
                    sizes="100px"
                    alt={event.title}
              ...
              {events.map((event, index) => (
                ...
                >
                  <picture>
                    <source 
                      type="image/webp"
                      srcSet={`${event.image}&w=300&fm=webp 300w, ${event.image}&w=400&fm=webp 400w, ${event.image}&w=600&fm=webp 600w`} 
                    />
                    <img 
                      src={event.image} 
                      srcSet={`${event.image}&w=300 300w, ${event.image}&w=400 400w, ${event.image}&w=600 600w`}
                      sizes="(max-width: 480px) 90vw, 80vw"
                      alt={event.title} 
                      className="poster-image"
                      loading={index === 0 ? "eager" : "lazy"}
                      decoding="async"
          ...
          {events.map((event, index) => (
            ...
            >
              <picture>
                <source 
                  type="image/webp"
                  srcSet={`${event.image}&w=80&fm=webp 80w, ${event.image}&w=160&fm=webp 160w`} 
                />
                <img 
                  src={event.image} 
                  srcSet={`${event.image}&w=80 80w, ${event.image}&w=160 160w`}
                  sizes="80px"
                  alt={event.title}
                  loading="lazy"
                  decoding="async"
